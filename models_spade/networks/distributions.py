'''
This code comes from the implementation of S-VAE (Hyperspherical VAE) available at:
https://github.com/nicola-decao/s-vae-pytorch
The paper is available at:
https://arxiv.org/pdf/1804.00891.pdf
Hyperspherical Variational Autoencoders, Tim R. Davidson, Luca Folsori, Nicola de Cao, Thomas Kipf, Jakub M. Tomczak
'''

import torch
from torch.distributions.kl import register_kl
from models_spade.networks.ive_function import ive, ive_fraction_approx, ive_fraction_approx2
import math
import torch
...
class VonMisesFisher(torch.distributions.Distribution):
    ...
    def rsample(self, shape=torch.Size()):
        # rsample uses a non parametric distribution (normal) to sample such that the
        # function is derivable. This doesn't happen with sample.
